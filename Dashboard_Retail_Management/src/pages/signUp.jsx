...
const SignUp = () => {
  ...
  const [ShowStorePassword, setShowStorePassword] = useState(false); // Store password toggle
  
  const [Formdata, setFormdata] = useState({
    identifier: "",
    password: "",
    storeName: "",
    storePassword: "", // Phone ki jagah Password
  });

  const loginMutation = useMutation({
    mutationFn: async (payload) => {
      // Admin Backend API call
  ...
  const handleSubmit = async (e) => {
    ...
    if (loginMode === "admin") {
      ...
      if (!Formdata.storeName || !Formdata.storePassword) {
        return toast.error("Please enter Store Name and Password");
      }
      
      // Simulation: Checking store from local list (Future mein API integrate kar sakte hain)
      ...
      <div className="hidden lg:flex w-1/2 bg-[#0e2a27] text-white p-8 lg:p-12 flex-col justify-center items-center relative">
        <div className="max-w-md text-center">
          ...
          <div className="space-y-4">
            <div className="inline-block bg-[#20b295]/20 border border-[#20b295] px-6 py-2 rounded-full text-[#20b295] font-black text-lg uppercase tracking-wider text-center">
              Book A free demo
            </div>
        ...
        <a href="https://wa.me/923405542097" target="_blank" rel="noreferrer" className="absolute bottom-6 right-6 bg-[#25D366] p-3 rounded-full shadow-lg hover:scale-110 transition-transform">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 md:p-10 relative">
        <div className="w-full max-w-sm">
          ...
          <div className="flex items-center gap-3 mb-6">
            <div className="bg-[#20b295] p-2.5 rounded-xl shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-left">
            {loginMode === "admin" ? (
              <>
                <div className="space-y-1.5">
                  ...
                  <input
                    type="text" placeholder="example@apex.com"
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-[#20b295] outline-none text-sm font-medium"
              ...
              <>
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="text" placeholder="e.g. Apexiums Mart"
                      className="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-[#20b295] outline-none text-sm font-medium"
                ...
                <div className="space-y-1.5 relative">
                  <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Store Portal Password</label>
                  <div className="relative">
                    <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-300" size={16} />
                    <input
                      type={ShowStorePassword ? "text" : "password"} placeholder="••••••••"
                      className="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-[#20b295] outline-none text-sm font-medium"
                      onChange={(e) => setFormdata({ ...Formdata, storePassword: e.target.value })}
                      value={Formdata.storePassword}
                    />
                    <button type="button" onClick={() => setShowStorePassword(!ShowStorePassword)} className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400">
            ...
            <button
              ...
              type="submit"
              className="w-full bg-[#13786E] hover:bg-[#0e5a52] text-white font-black uppercase tracking-widest py-4 rounded-xl shadow-lg transition-all active:scale-95 text-xs flex items-center justify-center gap-2 mt-4"
            >
            ...
            <div className="mt-6 text-center pt-4 border-t border-gray-100">
              ...
              <button
                type="button" onClick={() => setLoginMode(loginMode === "admin" ? "store" : "admin")}

...
const About = () => {
  return (
    <div className='flex-1 ml-60 min-h-screen flex items-center justify-center bg-[#F8FAFC]'>
      <div className='w-[50vw] h-[38rem] flex flex-col items-center justify-center rounded-xl shadow-2xl shadow-black-50 py-10 bg-white'>
